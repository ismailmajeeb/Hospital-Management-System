        ...
        public void Configure(EntityTypeBuilder<Doctor> builder)
        {
            ...
            builder.HasMany(d => d.Patients)
                   ...
                   .UsingEntity<Appointment>(
                    l => l.HasOne(c => c.Patient).WithMany(x => x.Appointments).HasForeignKey(x => x.PatientId).OnDelete(DeleteBehavior.Cascade),
                    r => r.HasOne(c => c.Doctor).WithMany(x => x.Appointments).HasForeignKey(x => x.CourseId).OnDelete(DeleteBehavior.Cascade)
