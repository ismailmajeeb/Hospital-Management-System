...
namespace HospitalManagementSystem.Controllers
{
    public class DoctorController : Controller
    {
        ...
        public async Task<IActionResult> Appointments(string Id = null)
        {
            ...
            var temp = await unitOfWork.Appointments.FindAllAsync(a => a.DoctorId == patient.Id, ["Patient"]);
        ...
        public async Task<IActionResult> MedicalRecords(string Id = null)
        {
            ...
            var temp = await unitOfWork.MedicalRecords.FindAllAsync(r => r.DoctorId == doctor.Id, includes: ["Patient", "Doctor","Appointment"]);
