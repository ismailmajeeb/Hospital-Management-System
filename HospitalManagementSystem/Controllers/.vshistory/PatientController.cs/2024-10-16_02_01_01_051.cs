...
namespace HospitalManagementSystem.Controllers
{
    public class PatientController : Controller
    {
        ...
        [HttpGet]
        [Authorize(Roles = $"{SD.Admin},{SD.Patient}")]
        public IActionResult MakeAppointment(string Id = null)
        {
            if (Id == null) 
                Id = User.FindFirstValue(ClaimTypes.NameIdentifier);
        ...
        public async Task<IActionResult> MakeAppointment(PatientMakeAppointmentModel model)
        {
            ...
            Appointment appointment = new()
            {
                ...
                Patient = await unitOfWork.Patients.FindAsync(p => p.UserId == model.PatientId),
            };
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        [Authorize(Roles = $"{SD.Doctor},{SD.Nurse},{SD.Admin}")]
