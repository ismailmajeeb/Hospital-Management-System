...
namespace HospitalManagementSystem.Controllers
{
    public class PatientController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            List<PatientsIndexModel> model = temp.Select(p => new PatientsIndexModel { Id = p.Id ,Name = p.Name, DoctorName = p.Doctor?.Name }).ToList();
            return View(model);
        ...
        public async Task<IActionResult> Create(CreateUserModel model)
        {
            ...
            return View("Index", temp.Select(p => new PatientsIndexModel { Name = p.Name, DoctorName = p.Doctor?.Name })
                                     .ToList());
        }
