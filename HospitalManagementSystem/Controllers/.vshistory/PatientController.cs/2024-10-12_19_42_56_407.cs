...
namespace HospitalManagementSystem.Controllers
{
    public class PatientController : Controller
    {
        ...
        //[ValidateAntiForgeryToken]
        [Authorize(Roles = SD.Patient)]
        public IActionResult Appointments(string userId)
        {
            var paitient =  unitOfWork.Patients.FindAsync(x => x.UserId == userId);
            if (paitient == null) return View("Error");
            PatientAppointmentsModel model = new PatientAppointmentsModel();
